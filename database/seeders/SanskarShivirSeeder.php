...
class SanskarShivirSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 2. Create Active Shivir 2026 - Ashoknagar
        $shivir2026 = Shivir::updateOrCreate(['slug' => 'sanskar-shivir-ashoknagar-2026'], [
            'name' => '33वाँ श्रावक संस्कार शिविर – अशोकनगर 2026',
            'shivir_number' => '33वाँ',
            'year' => 2026,
            'location' => 'अशोकनगर (म.प्र.)',
            'venue' => 'श्री दिगंबर जैन अतिशय क्षेत्र, अशोकनगर (म.प्र.)',
            'start_date' => '2026-08-25',
            'end_date' => '2026-09-04',
            'reg_start_date' => '2026-08-01',
            'reg_end_date' => '2026-08-24',
            'status' => 'registration_open',
            'max_limit' => 3000,
            'prefix' => 'ASH-2026-',
            'contact_info' => 'हेल्पलाइन: +91 94251 23456, +91 98262 67890 | ईमेल: info@punyodaya.in',
            'is_male_only' => true,
            'description' => 'परम पूज्य निर्यापक श्रमण मुनिश्री 108 सुधासागर जी महाराज के मंगल सानिध्य में 10 दिवसीय वार्षिक 33वाँ श्रावक संस्कार शिविर का आयोजन अशोकनगर की पावन धरा पर किया जा रहा है।',
        ]);
        ...
        $secPunyarjak = ShivirSection::create([
            ...
            'subtitle' => 'सौभाग्यशाली पुण्यार्जक परिवार',
            'description' => '33वें वार्षिक श्रावक संस्कार शिविर अशोकनगर के परम सौभाग्यशाली मुख्य पुण्यार्जक परिवार।',
        ...
        ShivirSectionItem::create([
            ...
            'name' => 'श्रृंगार परिवार, अशोकनगर',
            'designation' => 'शिविर मुख्य पुण्यार्जक',
            'department' => 'मातेश्वरी श्री कुसुमदेवी जी जैन, सुनील-सीमा, शैलेंद्र-कविता, संजीव-अंजू, मनीष-रिंकी, शैली-आयुष जी (सागर), शानू, सेजल, अंशिका, ख़ुशी, अतिशय, लिपि, नीनी, मोहित एवं गहना',
            'sort_order' => 1,
        ]);

        ShivirSectionItem::create([
            'shivir_section_id' => $secPunyarjak->id,
            'name' => 'भारत परिवार, अशोकनगर',
            'designation' => 'शिविर मुख्य पुण्यार्जक',
            'department' => 'मातेश्वरी श्रीमती समतादेवी जी, श्रीमती आशारानी जी, विकास-ममता, अभय-संगीता, रिंकू-रेशु, सिद्धार्थ (शालू भारत)- प्रतिभा, गौरव-ऐश्वर्या, स्वाति-अंकुर जी (पुणे), पीहू, कुहू, सर्वांग, अयांशी एवं जिनाया',
            'sort_order' => 2,
        ]);
        ...
        $secWelcome = ShivirSection::create([
            ...
            'subtitle' => 'धर्मनगरी अशोकनगर (म.प्र.) में सुधामय अमृत वर्षायोग 2025 का मंगल आमंत्रण पत्र',
        ...
        $teamItems = [
            // Leadership / Advisers
            ['name' => "प्रतिष्ठाचार्य बा.ब्र. श्री प्रदीप भैयाजी 'सुयश' (अशोकनगर)", 'designation' => 'शिविर परामर्शक', 'sort_order' => 1],
        ...
        $secOrganizers = ShivirSection::create([
            'shivir_id' => $shivir2026->id,
            'title' => 'आयोजक, निवेदक एवं विनीत',
            'subtitle' => 'दिगंबर जैन समाज एवं तीर्थक्षेत्र समिति - अशोकनगर',
            'description' => 'शिविर के मुख्य आयोजक, निवेदक एवं विनीत संस्थाएं।',
            'background' => 'bg-maroon-900',
            'sort_order' => 4,
            'is_active' => true,
        ]);
        ...
        $organizerItems = [
            ...
            ['name' => 'अध्यक्ष - राकेश जैन कांसल', 'designation' => 'आयोजक – श्री दिगंबर जैन पंचायत, अशोकनगर', 'mobile' => '9425132030', 'sort_order' => 1],
            ['name' => 'महामंत्री - राकेश जैन अमरोद', 'designation' => 'आयोजक – श्री दिगंबर जैन पंचायत, अशोकनगर', 'mobile' => '9425131933', 'sort_order' => 2],

            // निवेदक - श्री दिगंबर जैन दर्शनोदय अतिशय तीर्थक्षेत्र समिति, थूवौन जी, अशोकनगर
            ['name' => 'अध्यक्ष - अशोक जी (टिंगू)', 'designation' => 'निवेदक - श्री दिगंबर जैन दर्शनोदय अतिशय तीर्थक्षेत्र समिति, थूवौन जी, अशोकनगर', 'mobile' => '9425132065', 'sort_order' => 3],
            ['name' => 'महामंत्री - मनोज जैन (भैसरवास)', 'designation' => 'निवेदक - श्री दिगंबर जैन दर्शनोदय अतिशय तीर्थक्षेत्र समिति, थूवौन जी, अशोकनगर', 'mobile' => '9425407971', 'sort_order' => 4],

            // विनीत – सकल दिगंबर जैन समाज, अशोकनगर
            ['name' => 'सकल दिगंबर जैन समाज, अशोकनगर', 'designation' => 'विनीत – सकल दिगंबर जैन समाज, अशोकनगर', 'sort_order' => 5],
        ];
